...
func PaymentController(repository repository.Repository, categoryRepository repository.GenericRepository[model.Category], userRepository repository.Repository) Controller {
